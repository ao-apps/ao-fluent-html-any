...
public interface AnyUnion_Palpable_Phrasing<
   ...
   *
   * <p>See <a href="https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-ruby-element">4.5.10 The ruby element</a>.</p>
   *
   * @since HTML 5
   *
   ...
   *
   * <p>See <a href="https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-time-element">4.5.14 The time element</a>.</p>
   *
   * @since HTML 5
   *
