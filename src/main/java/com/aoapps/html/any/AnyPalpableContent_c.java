 ...
 */
public interface AnyPalpableContent_c<
    D  extends AnyDocument<D>,
    PC extends Content<D, PC>,
    _c extends AnyPalpableContent_c<D, PC, _c>
    >
    extends AnyPalpableContent<D, _c>,
    //
    // Unions:
    //
    AnyUnion_DL_Palpable_c<D, PC, _c>,
    ...
    AnyUnion_Palpable_Phrasing_c<D, PC, _c>,

    //
    // Content models:
    //
    // Inherited: Content_c<D, PC, _c>
    AnySectioningContent_c<D, PC, _c>,
    AnyHeadingContent_c<D, PC, _c>,
    AnyInteractiveContent_c<D, PC, _c> {
  // Inherited: AnyTextContent_c<D, PC, _c> // that is not inter-element whitespace
