...
public interface Onbeforeprint<E extends Element<?, ?, E> & Onbeforeprint<E>> {
   ...
   *
   * <p>See <a href="https://www.w3schools.com/tags/ev_onbeforeprint.asp">HTML onbeforeprint Event Attribute</a>.</p>
   *
   * @since HTML 5
   */
  public static final class onbeforeprint {
     ...
     */
    public static Object normalize(Object onbeforeprint) {
