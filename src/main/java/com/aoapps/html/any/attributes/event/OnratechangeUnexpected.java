...
public interface OnratechangeUnexpected<E extends Element<?, ?, E> & OnratechangeUnexpected<E>> {
  ...
  default E onratechange(Object onratechange) throws IOException {
    ...
    E element = (E) this;
    return Attributes.Event.attribute(element, "onratechange", onratechange, Onratechange.onratechange::normalize,
        value -> Attributes.validateInHtml5(element, "onratechange"));
  }
