...
public interface Onstorage<E extends Element<?, ?, E> & Onstorage<E>> {
  ...
  /**
   * Utility class for working with {@link Onstorage}.
   *
   * <p>See <a href="https://www.w3schools.com/tags/ev_onstorage.asp">HTML onstorage Event Attribute</a>.</p>
   *
   * @since HTML 5
   */
  public static final class onstorage {
    /** Make no instances. */
    private onstorage() {
  ...
  default E onstorage(Object onstorage) throws IOException {
    ...
    E element = (E) this;
    return Attributes.Event.attribute(element, "onstorage", onstorage, Onstorage.onstorage::normalize,
        value -> Attributes.validateInHtml5(element, "onstorage"));
  }
