...
public interface OntimeupdateUnexpected<E extends Element<?, ?, E> & OntimeupdateUnexpected<E>> {
  ...
  default E ontimeupdate(Object ontimeupdate) throws IOException {
    ...
    E element = (E) this;
    return Attributes.Event.attribute(element, "ontimeupdate", ontimeupdate, Ontimeupdate.ontimeupdate::normalize,
        value -> Attributes.validateInHtml5(element, "ontimeupdate"));
  }
