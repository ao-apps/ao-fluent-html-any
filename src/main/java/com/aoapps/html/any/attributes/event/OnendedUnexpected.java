...
// Matches Onended
@Deprecated
public interface OnendedUnexpected<E extends Element<?, ?, E> & OnendedUnexpected<E>> {
  ...
  default E onended(Object onended) throws IOException {
    ...
    E element = (E) this;
    return Attributes.Event.attribute(element, "onended", onended, Onended.onended::normalize,
        value -> Attributes.validateInHtml5(element, "onended"));
  }
