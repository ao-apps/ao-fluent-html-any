...
public interface OnsuspendUnexpected<E extends Element<?, ?, E> & OnsuspendUnexpected<E>> {
  ...
  default E onsuspend(Object onsuspend) throws IOException {
    ...
    E element = (E) this;
    return Attributes.Event.attribute(element, "onsuspend", onsuspend, Onsuspend.onsuspend::normalize,
        value -> Attributes.validateInHtml5(element, "onsuspend"));
  }
