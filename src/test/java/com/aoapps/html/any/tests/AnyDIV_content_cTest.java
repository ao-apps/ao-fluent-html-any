...
/**
 * @see  AnyDIV_content_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings("rawtypes")
public class AnyDIV_content_cTest {

  private final Class<? extends AnyDIV_content_c> testingClass;

  protected AnyDIV_content_cTest(Class<? extends AnyDIV_content_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnyDIV_content_cTest() {
    this(AnyDIV_content_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ElementContentModel_cTest.getAllElementContentModels(), AnyDIV_content_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnyDIV_content_c.class);
  }
}
