...
/**
 * @see  AnyEmbeddedContent_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings("rawtypes")
public class AnyEmbeddedContent_cTest {

  private final Class<? extends AnyEmbeddedContent_c> testingClass;

  protected AnyEmbeddedContent_cTest(Class<? extends AnyEmbeddedContent_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnyEmbeddedContent_cTest() {
    this(AnyEmbeddedContent_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ContentModel_cTest.getAllContentModels(), AnyEmbeddedContent_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnyEmbeddedContent_c.class);
  }
}
