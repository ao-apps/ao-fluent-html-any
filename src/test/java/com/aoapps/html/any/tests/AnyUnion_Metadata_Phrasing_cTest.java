...
/**
 * @see  AnyUnion_Metadata_Phrasing_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings({"rawtypes", "unchecked"})
public class AnyUnion_Metadata_Phrasing_cTest {

  private final Class<? extends AnyUnion_Metadata_Phrasing_c> testingClass;

  protected AnyUnion_Metadata_Phrasing_cTest(Class<? extends AnyUnion_Metadata_Phrasing_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnyUnion_Metadata_Phrasing_cTest() {
    this(AnyUnion_Metadata_Phrasing_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals("Must be included in " + AnyUnionContent_cTest.class.getSimpleName() + ".getAllUnions()",
        -1,
        AoArrays.indexOf(AnyUnionContent_cTest.getAllUnions(), AnyUnion_Metadata_Phrasing_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnyUnion_Metadata_Phrasing_c.class);
  }
}
