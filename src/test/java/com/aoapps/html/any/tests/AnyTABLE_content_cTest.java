...
/**
 * @see  AnyTABLE_content_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings("rawtypes")
public class AnyTABLE_content_cTest {

  private final Class<? extends AnyTABLE_content_c> testingClass;

  protected AnyTABLE_content_cTest(Class<? extends AnyTABLE_content_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnyTABLE_content_cTest() {
    this(AnyTABLE_content_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ElementContentModel_cTest.getAllElementContentModels(), AnyTABLE_content_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnyTABLE_content_c.class);
  }
}
