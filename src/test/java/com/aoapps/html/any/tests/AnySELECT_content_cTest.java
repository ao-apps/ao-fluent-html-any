...
/**
 * @see  AnySELECT_content_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings("rawtypes")
public class AnySELECT_content_cTest {

  private final Class<? extends AnySELECT_content_c> testingClass;

  protected AnySELECT_content_cTest(Class<? extends AnySELECT_content_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnySELECT_content_cTest() {
    this(AnySELECT_content_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ElementContentModel_cTest.getAllElementContentModels(), AnySELECT_content_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnySELECT_content_c.class);
  }
}
