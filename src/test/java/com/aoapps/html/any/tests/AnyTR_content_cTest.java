...
public class AnyTR_content_cTest {

  private final Class<? extends AnyTR_content_c> testingClass;

  protected AnyTR_content_cTest(Class<? extends AnyTR_content_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnyTR_content_cTest() {
    this(AnyTR_content_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ElementContentModel_cTest.getAllElementContentModels(), AnyTR_content_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnyTR_content_c.class);
  }
}
