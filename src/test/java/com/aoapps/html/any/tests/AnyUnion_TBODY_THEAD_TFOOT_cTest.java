...
/**
 * @see  AnyUnion_TBODY_THEAD_TFOOT_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings({"rawtypes", "unchecked"})
public class AnyUnion_TBODY_THEAD_TFOOT_cTest {

  private final Class<? extends AnyUnion_TBODY_THEAD_TFOOT_c> testingClass;

  protected AnyUnion_TBODY_THEAD_TFOOT_cTest(Class<? extends AnyUnion_TBODY_THEAD_TFOOT_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnyUnion_TBODY_THEAD_TFOOT_cTest() {
    this(AnyUnion_TBODY_THEAD_TFOOT_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals("Must be included in " + AnyUnionContent_cTest.class.getSimpleName() + ".getAllUnions()",
        -1,
        AoArrays.indexOf(AnyUnionContent_cTest.getAllUnions(), AnyUnion_TBODY_THEAD_TFOOT_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnyUnion_TBODY_THEAD_TFOOT_c.class);
  }
}
