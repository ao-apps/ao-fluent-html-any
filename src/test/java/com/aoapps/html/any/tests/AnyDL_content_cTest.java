...
public class AnyDL_content_cTest {

  private final Class<? extends AnyDL_content_c> testingClass;

  protected AnyDL_content_cTest(Class<? extends AnyDL_content_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnyDL_content_cTest() {
    this(AnyDL_content_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ElementContentModel_cTest.getAllElementContentModels(), AnyDL_content_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnyDL_content_c.class);
  }
}
