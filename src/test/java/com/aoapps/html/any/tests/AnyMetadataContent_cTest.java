...
/**
 * @see  AnyMetadataContent_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings("rawtypes")
public class AnyMetadataContent_cTest {

  private final Class<? extends AnyMetadataContent_c> testingClass;

  protected AnyMetadataContent_cTest(Class<? extends AnyMetadataContent_c> testingClass) {
    this.testingClass = testingClass;
  }

  public AnyMetadataContent_cTest() {
    this(AnyMetadataContent_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ContentModel_cTest.getAllContentModels(), AnyMetadataContent_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(Content_c.class, AnyMetadataContent_c.class);
  }
}
